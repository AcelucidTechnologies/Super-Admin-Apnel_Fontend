...
payload:any
  ...
  fileChangeEvent(event) {
    ...
    reader.onload = (data) => {
      ...
      console.log("bsnnner image post1" + data.target)
      console.log("bsnnner image post2" + this.Image)
      console.log("bsnnner image post3" +  data)
    }
  }
  ...
  getBannerById() {
    this.CmsService.getBannerById(this.id).subscribe((res) => {
      ...
      const test =this.bannerSpecialForm.patchValue({
